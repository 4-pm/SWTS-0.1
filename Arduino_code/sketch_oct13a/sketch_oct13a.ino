...
void loop() {  
  if (mySerial.available() > 0){
    ...
    if (b_com == '8'){
      ...
      int c_t_2 = 0; //дополнительное время движения мотора 1
      move_forward(255, 255, c_t, c_t_2); //параметры: скорость мотора 1, скорость мотора 2, время движения, дополнительное время движения мотора 1
    }
    if (b_com == '2'){
      Serial.println("SWTS are moving back");
      int c_t = 1000; //время движения
      int c_t_2 = 50; //дополнительное время движения мотора 1
      move_back(255, 255, c_t, c_t_2); //параметры: скорость мотора 1, скорость мотора 2, время движения, дополнительное время движения мотора 1
    }
    if (b_com == '4'){
      ...
      Serial.println(c_t);
      int c_t_2 = 0; //дополнительное время движения мотора 1
      move_left(220, 220, c_t, c_t_2); //параметры: скорость мотора 1, скорость мотора 2, время движения, дополнительное время движения мотора 1
    }
    if (b_com == '6'){
      ...
      Serial.println(c_t);
      int c_t_2 = 0; //дополнительное время движения мотора 1
      move_right(220, 220, c_t, c_t_2); //параметры: скорость мотора 1, скорость мотора 2, время движения, дополнительное время движения мотора 1
    }
  }
